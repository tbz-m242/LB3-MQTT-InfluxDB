...
#define MBED_CONF_APP_WIFI_DEBUG                                              0                                                                                                // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                                           "LkcDaQPFBFholvO"                                                                                // set by application
#define MBED_CONF_APP_WIFI_RX                                                 PTC14                                                                                            // set by application
#define MBED_CONF_APP_WIFI_SHIELD                                             WIFI_ESP8266                                                                                     // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "Orkan"                                                                                          // set by application
